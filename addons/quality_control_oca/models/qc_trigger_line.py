...
class QcTriggerLine(models.AbstractModel):
    ...
    _description = "Ligne abstraite pour définir les déclencheurs"
    ...
    partners = fields.Many2many(
        ...
        help="Si rempli, le test ne sera créé que lorsque l'action sera effectuée"
        " pour l'un des partenaires spécifiés. S'il est vide, le test sera toujours"
        " créé.",
