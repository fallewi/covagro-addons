        ...
        for rec in self:
            ...
            for bom in boms:
                ...
                if len(diff) > 0:
                    ...
                    raise UserError(
                        _(
                            "Ce modèle de produit est utilisé comme composant dans le "
                            "Les nomenclatures pour %(bom)s et attribut(s) %(attributs)s "
                            "n'est pas présent dans tous ces produits, et cela serait "
                            "casser le comportement de la nomenclature.",
