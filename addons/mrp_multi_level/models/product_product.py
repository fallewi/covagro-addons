...
class Product(models.Model):
    ...
    llc = fields.Integer(string="Code de bas niveau", default=0, index=True)
    ...
    mrp_area_ids = fields.One2many(
        ...
        inverse_name="product_id",
        string="Paramètres de la zone de fabrication",
    )
    mrp_area_count = fields.Integer(
        string="Nombre de paramètres de zone de fabrication",
        readonly=True,
