...
class MrpInventoryProcure(models.TransientModel):
    ...
    _description = "Faire des achats à partir des projections d'inventaire MRP"

    item_ids = fields.One2many(
        comodel_name="mrp.inventory.procure.item", inverse_name="wiz_id", string="Elements"
    )
...
class MrpInventoryProcureItem(models.TransientModel):
    ...
    _description = "Article d'approvisionnement d'inventaire MRP"
    ...
    uom_id = fields.Many2one(string="Unité de mesure", comodel_name="uom.uom")
    ...
    warehouse_id = fields.Many2one(string="Entrepôt", comodel_name="stock.warehouse")
