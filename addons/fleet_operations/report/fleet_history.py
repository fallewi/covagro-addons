...
class FleetHistorySummary(models.TransientModel):
    ...
    file = fields.Binary("Cliquez sur le lien de téléchargement pour télécharger le fichier Xls",
                         readonly=True)
...
class PrintFleetHistory(models.TransientModel):
    ...
    _description = "Imprimer l'historique de la flotte"

    sel_report = fields.Selection([
        ('history', 'Historique de la flotte'),
